...
# MQTT CLIENT CONFIG
mqttc = mqtt.Client()
mqttc.username_pw_set("Enter Your Username here", password="Enter Password")
mqttc.connect("Enter the IP Address of your IOT Cloud Service", Port Number goes here)
mqttc.loop_start()
